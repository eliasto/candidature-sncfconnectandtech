          ...
          child: Column(
            ...
            children: [
              Container(
                ...
                decoration: const BoxDecoration(
                    image: DecorationImage(
                        image: AssetImage('assets/motivations.jpg'),
                        fit: BoxFit.cover)),
              ),
              const Padding(
              ...
              const Padding(
                  ...
                  child: Text(
                      "Après avoir passé (beaucoup) de temps sur cette application, il est temps de vous expliquer mes motivations. Déjà, j'adore voyager (et surtout en train). Que ce soit pour faire mes aller-retour entre Gare de l'Est et Strasbourg, en InterRail à travers l'Europe, à bord des KTX en Corée du Sud (ce réseau existe grâce à la SNCF, incroyable !) ou encore des Shinkansen japonais, j'ai vu comment la mobilité fonctionne aux quatre coins du monde.\n\nJe veux être un acteur de la mobilité de demain, et je pense qu'il n'y a pas meilleur endroit que chez SNCF Connect & Tech pour le faire : SNCF Connect est le plus gros projet Flutter d'Europe et le plus grand site e-commerce de voyage en France. Le défi s'annonce de taille !\n\nJe souhaite innover pour permettre de rendre les mobilités durables une réalité, et je pense que je peux être un acteur avec mes compétences en rejoignant votre équipe (et puis vous utilisez Next.JS et Flutter, les deux technologies que j'utilise principalement : cela me donne encore plus envie de vous rejoindre). Je suis un jeune homme avec la tête pleine de rêves et qui ne souhaite que les réaliser.\nJe me ferais un plaisir d'avoir un entretien avec vous pour discuter plus en détail de mes motivations et de mes compétences.\n\nMerci d'avoir pris le temps d'explorer cette application,\nElias.")),
              const Help()
            ],
          ),
        ),
